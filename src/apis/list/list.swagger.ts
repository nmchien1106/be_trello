...
export const ListRegisterPaths = () => {
    ...
    listRegistry.registerPath({
        ...
        request: {
            params: z.object({
                listId: z.string().uuid().openapi({ description: 'ID of the list to reorder' })
            }),
            body: {
                ...
                content: {
                    'application/json': {
                        schema: z.object({
                            ...
                            boardId: z.string().uuid().openapi({ description: 'ID of the board containing the lists.' })
                        })
                    }
                }
            }
    ...
    listRegistry.registerPath({
        ...
        request: {
            params: z.object({
                listId: z.string().uuid().openapi({ description: 'ID of the list to move' })
            }),
            body: {
    ...
    listRegistry.registerPath({
        ...
        request: {
            params: z.object({
                listId: z.string().uuid().openapi({ description: 'ID of the list to duplicate' })
            }),
            body: {
                ...
                content: {
                    'application/json': {
                        schema: z.object({
                            boardId: z.string().uuid().openapi({ description: 'ID of the board where the duplicated list will be created' }),
